...
const InductionIndex = () => {
  ...
  const no_user_err_message = (
    <>
      Can't find any user with the given details. This can be because of either
      of these 2 reasons...
      <ul>
        <li>
          You have not given the email you gave when registering. Try using
          another email/phone if you have a alternative one.
        </li>
        <li>
          We haven't updated your profile to mark you as a volunteer yet. If you
          think this is the case, reach out to one of the orginizers of the
          induction and get it fixed right now. You'll need this to be done to
      ...
      <IonContent className="dark">
        <IonCard className="dark loginCard">
          <IonCardHeader>
            ...
            <IonCardSubtitle>
              We'll be setting up your profile in our database now. To continue,
              please enter the email you provided when registering for MAD
            </IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            ...
            <IonItem>
              {message.length && (
                <span className={message[1] + '-message'}>{message[0]}</span>
              )}
            </IonItem>
          </IonCardContent>
        </IonCard>
