      ...
      <IonContent className="dark">
        <IonCard className="dark">
          <IonCardHeader>
            ...
            <IonCardSubtitle>
              <p>
                Congratulations! Now, you have access to all of MAD Tech.
                You&apros;ll be able to
              </p>
              <ul>
          ...
          <IonCardContent>
            ...
            {step === 'home-page' ? (
              <>
                <IonItem>
                  First, you&apros;ll have to add this app to your phone.
                  Hopefully you&apros;ll be using this from your phone - if you
                  are NOT using this on your phone, skip to the next step.
                </IonItem>
                ...
                <IonItem>
                  {browser === 'firefox' ? (
                    <span>
                      ...
                      on &apros;+ Add to Home Screen&apros;
                    </span>
                  ) : (
                ...
                <IonItem className="padded">
                  <IonButton
                    size="default"
                    onClick={() => setStep('notification-permission')}
                  >
                    Next Step
                  </IonButton>
                </IonItem>
            ...
            {step === 'notification-permission' ? (
              <>
                <IonItem>
                  ...
                  To let us do that, click on the button below and then press
                  Allow.
                </IonItem>
