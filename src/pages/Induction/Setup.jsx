                    ...
                    <IonCardContent>                                                                        
                        ...
                        { (step === "set-password") ? 
                            (<>
                                ...
                                <IonItem className="padded">
                                    ...
                                    <IonInput id="new-password" type="password" placeholder="Password" />
                                </IonItem>

                                <IonItem className="padded">
                                    <IonLabel position="stacked">Re-Enter Password.</IonLabel>
                                    <IonInput id="confirm-password" type="password" placeholder="Confirm Password" />
                                </IonItem>
                        ...
                        { (step === "notification-permission") ? 
                            (<>
                                ...
                                <IonItem className="padded">
                                    <IonButton size="default" onClick={notificationPermission}>Set Notification Permission</IonButton>
                                </IonItem>
                            </>)
                            : null }
