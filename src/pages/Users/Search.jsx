        ...
        <IonCard className="dark">
          ...
          <IonCardContent>
            ...
            <InputRow
              ...
              id="any_email"
              type="text"
              value={search.any_email}
              onIonInput={(e) => setSearchValue('any_email', e.target.value)}
            />
            <InputRow
              ...
              type="text"
              value={search.phone}
              onIonInput={(e) => setSearchValue('phone', e.target.value)}
            />
            ...
            {showMore ? (
              <div className="more-options">
                ...
                <IonItem>
                  ...
                  <IonSelect
                    ...
                    interface="popover"
                    onIonChange={(e) =>
                      setSearchValue('user_type', e.target.value)
                    }
                  >
                    <IonSelectOption value="volunteer" selected={true}>
                      Volunteer
                    </IonSelectOption>
                    <IonSelectOption value="applicant">
                      Applicant
                    </IonSelectOption>
              ...
              <IonItem onClick={() => setShowMore(true)}>
                <a>Show More Options...</a>
              </IonItem>
            )}
    ...
    <IonList>
      {users.length &&
        users.map((user, index) => {
          return <UserDetail user={user} index={index} key={index} />
        })}
      {users.length === 0 ? (
        <IonItem>
