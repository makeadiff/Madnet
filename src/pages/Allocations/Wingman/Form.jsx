                ...
                <form onSubmit = {saveAssign}>
                    <IonList>
                        <IonItem>
                            ...
                            <IonSelect slot ="end" name = "wingman_id" value={wingman_id.id} onIonChange = {updateWingman} required = "true" >
                        ...
                        <IonItem>
                            ...
                            <IonSelect slot ="end" name="student_id" value = {student_id.student_ids} onIonChange = {updateStudent}  required = "true">
