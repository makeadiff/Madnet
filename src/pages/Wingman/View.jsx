...
const WingmanView = () => {
    ...
    const deleteMapping = (x) => {
         ...
         callApi({url:`/batches/${batch_id[x]}/levels/${level_id[x]}/teachers/${wingman_id[x]}`, method: 'delete'}).then((data)=>{
            showMessage("Deleted")
                                    ...
                                    <IonList>
                                        ...
                                        {   
                                            (batch.allocations.map((alloc, index_2) =>{ 
                                                ...
                                                <IonButton key = {index_2} slot = "end" onClick = {()=>deleteMapping(index_2)}> Delete </IonButton>
                                                </IonItem>  
                                                );
                                            }))
                                        }
