import { IonContent,IonPage,IonCard,IonCardHeader,IonCardTitle,IonCardSubtitle,IonCardContent, IonTextarea, IonButton } from '@ionic/react'
...
const Notes = ({ item_type }) => {
    ...
    const addNewNote = () => {
        ...
        callApi({url: `/${item_type_plural}/${item_id}/comments`, method:"post", params: {
            comment: note,
        ...
        <IonPage>
            ...
            <IonContent>
                ...
                <IonCard class="light list" routerDirection="none" >
                    <IonCardHeader className="noPadding">
                        <IonCardTitle><p>New Note</p></IonCardTitle>
                    </IonCardHeader>
                    <IonCardContent>
                        <IonTextarea value={ note } onIonChange={ updateNote } required={ true }
                            placeholder="Add any comments here"></IonTextarea>
                        <IonButton type="submit" onClick={ addNewNote }>Add Note</IonButton>
                    </IonCardContent>
                </IonCard>
